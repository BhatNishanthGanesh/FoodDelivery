      ...
      <div className='container'>
        <form onSubmit={handleSubmit}>
          <div className="form-group mb-3">
            ...
            <input type="text" className="form-control" name='name' value={credential.name} onChange={onChange} placeholder="Enter Name" />
          </div>
          <div className="form-group mb-3">
          ...
          <div className="form-group mb-3">
            ...
            <input type="text" className="form-control" name='geolocation' value={credential.geolocation} onChange={onChange} id="exampleInputPassword1" placeholder="Enter your address" />
          </div>
